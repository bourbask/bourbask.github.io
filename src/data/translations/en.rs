...
pub fn get_translations() -> HashMap<&'static str, &'static str> {
    ...
    map.insert("veille.synthesis.title", "Today's Synthesis");
    map.insert("veille.synthesis.tldr", "In short");
    map.insert("veille.synthesis.keyTakeaways", "Key Takeaways");
    map.insert("veille.synthesis.signalVsNoise", "Signal vs. noise");
    map.insert("veille.synthesis.aiGenerated", "Generated by Claude AI");
    map.insert("veille.synthesis.hide", "Hide");
    map.insert("veille.synthesis.show", "Show");
    map.insert("veille.synthesis.notAvailable", "Synthesis not available for this period.");
